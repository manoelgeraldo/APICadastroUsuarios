...
namespace APICadastroUsuario.Configuracoes.v1
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get(int id)
        {
            ...
            if (usuario is null) return NotFound("Usuário não existe na base de dados!");
            return Ok(usuario);
        }
        ...
        public async Task<IActionResult> Post(NovoUsuario novoUsuario)
        {
            ...
            if (usuarioInserido != null) return CreatedAtAction(nameof(Get), new { id = usuarioInserido.Id }, usuarioInserido);
        ...
        public async Task<IActionResult> Put(AlterarUsuario alterarUsuario)
        {
            ...
            if (usuarioAlterado is null) return NotFound("Usuário não existe na base de dados!");
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if (usuarioExcluido is null) return NotFound("Usuário não existe na base de dados!");
